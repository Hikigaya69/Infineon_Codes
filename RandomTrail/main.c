...
int main(void)
{
	...
	printf("PSOC_OPTIGA_IOT_KIT template is ready to start.\r\n");
		...
		//mbedtls_ctr_drbg_seed(&random_context,mbedtls_entropy_func,&entropy_context,"what",4);
		...
		for(int i=0;i<10;i++)
			{
				...
				//int ret = mbedtls_ctr_drbg_random(&random_context,rand_num2,sizeof(rand_num2));
